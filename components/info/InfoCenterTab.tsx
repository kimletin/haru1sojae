...
// 도움말 항목 제목 — 이모지는 환경별 폰트에 없으면 깨지므로(예: 🪙 Unicode 14) 주황 원 불릿으로 통일
const helpHeading = 'font-semibold text-gray-900 dark:text-zinc-100 mb-1 flex items-center';
const helpBullet = 'inline-block w-2.5 h-2.5 rounded-full bg-orange-500 mr-2 shrink-0';
      ...
      <div className="bg-white dark:bg-zinc-900 rounded-xl border border-gray-100 dark:border-zinc-700 shadow-sm overflow-hidden flex flex-col">
        ...
        {activeSection === '도움말' && (
          <div className="p-5 space-y-4 text-sm text-gray-700 dark:text-zinc-300 leading-relaxed flex-1">
            <div>
              <p className={helpHeading}><span className={helpBullet} />서비스 대상</p>
            ...
            <div>
              <p className={helpHeading}><span className={helpBullet} />가성비 배율 기준</p>
            ...
            <div>
              <p className={helpHeading}><span className={helpBullet} />가격 환산 기준</p>
            ...
            <div>
              <p className={helpHeading}><span className={helpBullet} />도핑류 계산 주의사항</p>
            ...
            <div>
              <p className={helpHeading}><span className={helpBullet} />에픽 던전 세라자르 주화</p>
            ...
            <div>
              <p className={helpHeading}><span className={helpBullet} />마스터라벨 성장 플러스</p>
              <p><span className="font-semibold text-orange-500">마스터라벨 아이템</span> 보유를 전제로, <span className="font-semibold text-orange-500">성장 플러스 구매 비용만</span> 반영합니다. 마스터라벨 구매 비용은 계산에서 제외됩니다.</p>
            </div>
            <div>
              <p className={helpHeading}><span className={helpBullet} />패스 내 아이템 계산 기준</p>
              <p>패스에 포함된 <span className="font-semibold text-orange-500">경험치 쿠폰</span>은 부스터류 아이템을 사용하지 않은 <span className="font-semibold text-orange-500">순수 사냥 경험치</span>를 기준으로 계산합니다. 패스에 포함된 <span className="font-semibold text-orange-500">부스터류 아이템</span>은 추가 경험치 획득량 <span className="font-semibold text-orange-500">800%</span>를 가정해 계산합니다.</p>
            </div>
          </div>
        )}
      </div>
